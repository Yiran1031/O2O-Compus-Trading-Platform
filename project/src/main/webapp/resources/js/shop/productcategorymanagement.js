$(function() {
	var listUrl = '/project/shopadmin/getproductcategorylist';
	var addUrl = '/project/shopadmin/addproductcategorys';
	var deleteUrl = '/project/shopadmin/removeproductcategory';
	getList();
	function getList() {
		$
				.getJSON(
